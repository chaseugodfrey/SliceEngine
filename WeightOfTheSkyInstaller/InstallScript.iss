...
AppId={{B0CE1F97-F386-4016-BB53-8F160C79E007}

; Standard app data stuff
; !!NOTE!!: Replace all instances of "GameTest" with your game name.
AppName=WeightOfTheSky
AppVerName=WeightOfTheSky Version 0.1
...
DefaultDirName={pf}\DigiPen\WeightOfTheSky

; Start menu directory
DefaultGroupName=DigiPen\WeightOfTheSky

; Output directory for the installer.
OutputDir=.\INSTALLER

; Setup executable installer
OutputBaseFilename=WeightOfTheSky_Setup
...
[Icons]
Name: "{group}\WeightOfTheSky"; Filename: "{app}\WeightOfTheSky.exe"; WorkingDir: "{app}"; IconFilename: "{app}\Icon.ico"
Name: "{group}\{cm:UninstallProgram,WeightOfTheSky}"; Filename: "{uninstallexe}"
Name: "{group}\{cm:UninstallProgram,WeightOfTheSky}"; Filename: "{uninstallexe}"; IconFilename: "{app}\Icon.ico"
Name: "{commondesktop}\WeightOfTheSky"; Filename: "{app}\WeightOfTheSky.exe"; Tasks: desktopicon; WorkingDir: "{app}"; IconFilename: "{app}\Icon.ico"
...
Filename: {app}\WeightOfTheSky.exe; Description: {cm:LaunchProgram,WeightOfTheSky}; Flags: nowait postinstall skipifsilent
