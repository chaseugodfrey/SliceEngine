/*-------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 brief:		  Defines the PrefabViewWindow class, which is responsible for drawing the Scene View window and its contents.
...
#pragma region Dropping Into the Scene Directly
		...
		ImGuiID id = ImGui::GetCurrentWindow()->GetID("PrefabSceneCanvasPassive");
		ImRect rect(p0, p1);
