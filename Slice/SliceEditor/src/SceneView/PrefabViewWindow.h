/*-------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 brief:		  Declares the PrefabViewWindow class, which is responsible for drawing the Scene View window and its contents.
...
#ifndef PREFAB_SCENE_VIEW_H
#define PREFAB_SCENE_VIEW_H

#include "../WindowManager/EditorWindow.h"

namespace SliceEditor
{
	class PrefabViewWindow : public EditorWindow
	{
		struct SceneCamera
		{
			entt::entity entity;
	...
	public:
		...
		PrefabViewWindow(Registry& reg) : EditorWindow(reg) {};
		~PrefabViewWindow() = default;
