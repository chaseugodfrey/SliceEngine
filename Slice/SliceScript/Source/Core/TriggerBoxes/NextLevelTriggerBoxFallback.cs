...
{
    public class NextLevelTriggerBoxFallback : SliceBehaviour
    {
        ...
        public float doorRiseWeight = 1f;
        ...
        public override void OnUpdate(float dt)
        {
            ...
            if (counting)
            {
                ...
                Vector3 temp = DoorModel.GetComponent<Transform>().Position;
                temp.y += doorRiseWeight;
                DoorModel.GetComponent<Transform>().Position = temp;
                if (count >= LoadDelay)
                {
