...
{
    public class CameraCinematicLerp : SliceBehaviour
    {

        public class PretextState : BaseState
        {
            private CameraCinematicLerp owner;
            ...
            {
                this.owner = owner.As<CameraCinematicLerp>();
                hasText = owner.As<CameraCinematicLerp>().hasText;
            }
            ...
            public override void OnEnter()
            {
                ...
                if (hasText)
                {
                    Bootstrap.HUDManager.PlayDialogueForLevel(owner.levelSet,owner.dialogueSet, true, true);
                }
            }
            ...
            public IEnumerator LerpThrough()
            {
                ...
                float duration = owner.panDuration;
       ...
       public GameObject camera;
        ...
        public float panDuration = 28f;

        public int dialogueSet = 0;
        public int levelSet = 0;
