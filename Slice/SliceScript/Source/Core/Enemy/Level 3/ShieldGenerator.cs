...
namespace SliceEngine
{
    public class ShieldGenerator : EnemyBase
    {
        ...
        {
            base.SetUp(); // Enemy base has rigibody idk if the shield generator needs but its the only way for enemies to take damage now
        }
        public override void OnCreate()
        {
            base.OnCreate(); // justy use enemy base on create for now, if we need to add more functionality we can always override it in the future
        }
