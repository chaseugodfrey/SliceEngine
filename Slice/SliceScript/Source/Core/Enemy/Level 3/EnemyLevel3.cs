...
namespace SliceEngine
{
    ...
    public class IntroStateLevel3 : BaseState
    {
        ...
        public IntroStateLevel3(GameObject owner, EnemyLevel3 controller) : base(owner)
        {
    ...
    public class IdleStateLevel3 : BaseState
    {
        EnemyLevel3 enemyController;
        public int moves = 0;

        public IdleStateLevel3(GameObject owner, EnemyLevel3 controller) : base(owner)
        {
            enemyController = controller;
        }
        public override void OnEnter()
    ...
    public class SlamStateLevel3 : BaseState
    {
        EnemyLevel3 enemyController;
        ...
        public SlamStateLevel3(GameObject owner, EnemyLevel3 controller) : base(owner)
        {
            enemyController = controller;
        }
    ...
    public class ProjectileStateLevel3 : BaseState
    {
        EnemyLevel3 enemyController;
        ...
        public ProjectileStateLevel3(GameObject owner, EnemyLevel3 controller) : base(owner)
        {
            enemyController = controller;
        }
        public override void OnEnter()
    ...
    public class DeathStateLevel3 : BaseState
    {
        EnemyLevel3 enemyController;
        ...
        public DeathStateLevel3(GameObject owner, EnemyLevel3 controller) : base(owner)
        {
            enemyController = controller;
        }
    ...
    public class EnemyLevel3 : EnemyBase
    {
        ...
        public IdleStateLevel3 idleState;
        public IntroStateLevel3 introState;
        public SlamStateLevel3 slamState;
        public ProjectileStateLevel3 projectileState;
        public DeathStateLevel3 deathState;
        ...
        public override void OnCreate()
        {
            ...
            idleState = new IdleStateLevel3(this.gameObject, this);
            introState = new IntroStateLevel3(this.gameObject, this);
            slamState = new SlamStateLevel3(this.gameObject, this);
            projectileState = new ProjectileStateLevel3(this.gameObject, this);
            deathState = new DeathStateLevel3(this.gameObject, this);
