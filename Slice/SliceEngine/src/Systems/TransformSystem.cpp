...
namespace SliceEngine
{
	...
	std::unordered_set<Entity> TransformSystem::FetchFrustrumCull(GameObject& camObj)
	{
		...
		// Start
		// -------------------------------------------------------------
		auto& transform = camObj.GetComponent<Transform>();
	...
	void TransformSystem::AddGridEntities(std::unordered_set<Entity>& in, const int& x, const int& z)
	{
